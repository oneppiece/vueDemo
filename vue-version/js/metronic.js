		...
		$('body')
				.on(
						...
						function(e) {
							...
							portlet.find('.portlet-title .fullscreen').tooltip(
									'destroy');
				...
				.on(
						...
						function(e) {
							...
							if (portlet.hasClass('portlet-fullscreen')) {
								...
								$('body')
										.removeClass('page-portlet-fullscreen');
								portlet.children('.portlet-body').css('height',
										'auto');
							} else {
	...
	var handleMaterialDesign = function() {
		...
		$('body').on('click', '.md-checkbox > label, .md-radio > label',
				function() {
					...
					// add the bubble class (we do this so it doesnt show on
					// page load)
					el.addClass('inc');
					...
					// remove the original so that it is ready to run on next
					// click
					...
					.on(
							...
							function(e) {
								...
								if (element.find(".md-click-circle").length == 0) {
									element
											.prepend("<span class='md-click-circle'></span>");
								}
								...
								if (!circle.height() && !circle.width()) {
									d = Math.max(element.outerWidth(), element
											.outerHeight());
									circle.css({
										height : d,
										width : d
		...
		$('[data-auto-height]').each(
				function() {
					...
					items.each(function() {
						...
						var height_ = (mode == 'base-height' ? $(this)
			...
			$(el).each(
					function() {
						if ($(this).attr("data-initialized") === "1") { // destroy
							...
							// store the custom attribures so later we will
							// reassign.
							if ($(this).attr("data-handle-color")) {
								attrList["data-handle-color"] = $(this).attr(
										"data-handle-color");
							}
							if ($(this).attr("data-wrapper-class")) {
								attrList["data-wrapper-class"] = $(this).attr(
										"data-wrapper-class");
							}
							if ($(this).attr("data-rail-color")) {
								attrList["data-rail-color"] = $(this).attr(
										"data-rail-color");
							}
							...
							if ($(this).attr("data-rail-visible")) {
								attrList["data-rail-visible"] = $(this).attr(
										"data-rail-visible");
							}

							$(this).slimScroll(
									{
										wrapperClass : ($(this).attr(
												"data-wrapper-class") ? $(this)
